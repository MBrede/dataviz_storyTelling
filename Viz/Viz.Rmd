...
```{r, fig.cap='Time-series of infections and restrictions.'}
...
```{r, fig.cap='Mean sentiment per region as detected in the mainstrem-news articles about the respective other country.'}
